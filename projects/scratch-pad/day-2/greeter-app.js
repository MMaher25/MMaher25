...
function greeter(hour) {
    ...
    //return a greeting based on input hour
    //if hour is 0-11, console.log "Good Morning"
    if (hour <= 11) {
        console.log("Good Morning!");
    }
    //if hour is 12-16, console.log "Good Afternoon"
    else if (hour <=16) {
        console.log("Good Afternoon!");
    }
    //if hour is 17-21, console.log "Good Evening"
    else if (hour <= 21) {
        console.log("Good Evening!");
    }
    //if hour is 22-24, console.log "Good Night"
    else {
